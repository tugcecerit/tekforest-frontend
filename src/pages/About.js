    ...
    <div className="about">
        <div className='about-content'>
            <div className="about-text">
                ...
                <p>TEKforest was born out of our deep appreciation for the beauty and wonder of plants. As avid plant lovers ourselves, we felt the need for a dedicated online platform that brings together plant enthusiasts from all walks of life. We wanted to create a space where people can learn, share, and connect over their mutual love for plants.</p>
